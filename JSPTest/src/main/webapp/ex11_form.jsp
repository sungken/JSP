	...
	<form method="POST" action="ex11_ok.jsp">
		<table class="vartical">
			...
			<tr>
				<th>라디오 버튼</th>
				<td>
					<h3>성별을 선택하시오.</h3> <label><input type="radio" name="rb"
						value="male"> 남자</label> <label><input type="radio"
						name="rb" value="female"> 여자</label>
				</td>
			</tr>
			<tr>
				<th>셀렉트 박스</th>
			...
			<tr>
				<th>셀렉트 박스2</th>
				<td><select name="sel2" multiple="multiple">
						<option value="1">사과</option>
						<option value="2">귤</option>
						<option value="3">바나나</option>
				</select></td>
			...
			<tr>
				<th>사용자 정의 컨트롤</th>
				<td>
					<img alt="" src="images/catty01.png" id="cat1" >
				</td>
			</tr>
